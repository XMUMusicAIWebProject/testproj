    ...
    <nav class="navbar navbar-default row ">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand  "  >我的主页</div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <form class="form-fun" action="/seminar/selectAll" method="post">
                    <button class="btn btn-lg btn-primary btn-block" type="submit">讨论课</button>
                </form>
            </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
    </nav>
